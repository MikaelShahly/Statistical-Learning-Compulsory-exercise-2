...
This project aimed to predict heart disease using various different statistical learning models, and compare these. We used twelve predictors for this purpose. The main goal for these models was achieving high accuracy rather than interpretability. We discovered that boosted techniques outperformed traditional methods like logistic regression and normal decision trees. Our best-performing model was the Boosted Decicion Tree with tuned hyperparamaters, this achieved an accuracy of $88.6\%$. Overall, this paper shows the utility of statistical learning models for predicting heart disease.
